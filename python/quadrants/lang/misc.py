    ...
    **kwargs,
    ...
    Args:
        ...
        **kwargs: Quadrants provides highly customizable compilation through
            ...
            *``debug_dump_path`` (str): used as the base path for QD_DUMP_IR and similar. QD_LOAD_IR and QUADRANTS_LOAD_PTX read replacement IR / PTX from this directory, and require ``offline_cache=False`` and ``src_ll_cache=False``.
    """
