...
class JITSessionCUDA : public JITSession {
 public:
  ...
  // unchanged task). Keyed on the module's LLVM-IR text -- see the definition for why the per-task IR key is not used
  // here even though the artifact cache keys on it.
